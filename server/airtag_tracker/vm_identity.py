...
# iMac19,1 — matches the board-id already injected by OpenCore
# (Mac-AA95B1DDAB278B95). Changing the product would require changing
# the board-id too, so we keep iMac19,1 as the model.
MODEL = "iMac19,1"
